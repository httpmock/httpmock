use crate::{
    ...
    server::matchers::{
        comparators::{
            AnyValue, BytesEquals, BytesIncludes, BytesMatches, BytesPrefix, BytesSuffix, FunctionMatchesRequest,
            HostEquals, JsonEquals, JsonIncludes, StringEquals, StringIncludes, StringMatches, StringPrefix,
            StringSuffix, U16Equals,
        },
        generic::{
...
pub(crate) fn all() -> Vec<Box<dyn Matcher + Sync + Send>> {
    vec![
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(StringIncludes::new(false, false)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Absence,
            comparator: Box::new(StringIncludes::new(false, true)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(StringPrefix::new(false, false)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Absence,
            comparator: Box::new(StringPrefix::new(false, true)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(StringSuffix::new(false, false)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Absence,
            comparator: Box::new(StringSuffix::new(false, true)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matcher_method: "port",
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(U16Equals::new(false)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Absence,
            comparator: Box::new(U16Equals::new(true)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(StringIncludes::new(true, false)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Absence,
            comparator: Box::new(StringIncludes::new(true, true)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(StringPrefix::new(true, false)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Absence,
            comparator: Box::new(StringPrefix::new(true, true)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(StringSuffix::new(true, false)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Absence,
            comparator: Box::new(StringSuffix::new(true, true)),
        ...
        Box::new(MultiValueMatcher {
            ...
            key_required: true,
            key_comparator: Box::new(StringEquals::new(true, false)),
            value_comparator: Box::new(StringIncludes::new(true, false)),
            weight: 1,
        }),
        Box::new(MultiValueMatcher {
            entity_name: "query parameter",
            ...
            key_required: true,
            key_comparator: Box::new(StringEquals::new(true, false)),
            value_comparator: Box::new(StringIncludes::new(true, true)),
            weight: 1,
        }),
        Box::new(MultiValueMatcher {
            entity_name: "query parameter",
            ...
            key_required: true,
            key_comparator: Box::new(StringEquals::new(true, false)),
            value_comparator: Box::new(StringPrefix::new(true, false)),
            weight: 1,
        }),
        Box::new(MultiValueMatcher {
            entity_name: "query parameter",
            ...
            key_comparator: Box::new(StringEquals::new(true, false)),
            value_comparator: Box::new(StringPrefix::new(true, true)),
            weight: 1,
        }),
        Box::new(MultiValueMatcher {
            entity_name: "query parameter",
            ...
            key_required: true,
            key_comparator: Box::new(StringEquals::new(true, false)),
            value_comparator: Box::new(StringSuffix::new(true, false)),
            weight: 1,
        }),
        Box::new(MultiValueMatcher {
            entity_name: "query parameter",
            ...
            // TODO: ATTENTION: still false, because it is expected that the key appears in the request!
            key_comparator: Box::new(StringEquals::new(true, false)),
            value_comparator: Box::new(StringSuffix::new(true, true)),
            weight: 1,
        }),
        Box::new(MultiValueMatcher {
            entity_name: "query parameter",
        ...
        Box::new(SingleValueMatcher {
            ...
            matcher_method: "body",
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(BytesEquals::new(false)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Absence,
            comparator: Box::new(BytesEquals::new(true)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(BytesMatches::new()),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(JsonEquals::new()),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Presence,
            comparator: Box::new(JsonIncludes::new(false)),
        ...
        Box::new(SingleValueMatcher {
            ...
            matching_strategy: MatchingStrategy::Absence,
            comparator: Box::new(JsonIncludes::new(true)),
